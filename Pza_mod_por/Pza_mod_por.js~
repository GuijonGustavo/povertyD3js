...
function distQuant(dato, legRow){
	...
	function mouseoverLegend(_,p){	
		...
		if (p ==0 ){	
		updateData("Pza_mod_por/db/Ags.json");}
		if (p ==1 ){	
		updateData("Pza_mod_por/db/Bcn.json");}

		if (p ==2 ){	
		updateData("Pza_mod_por/db/Bcs.json");}
		if (p ==3 ){	
		updateData("Pza_mod_por/db/Cam.json");}

		if (p ==4 ){	
		updateData("Pza_mod_por/db/Chp.json");}
		if (p ==5 ){	
		updateData("Pza_mod_por/db/Chi.json");}
		if (p ==6 ){	
		updateData("Pza_mod_por/db/Dif.json");}
		if (p ==7 ){	
		updateData("Pza_mod_por/db/Coa.json");}
		if (p ==8 ){	
		updateData("Pza_mod_por/db/Col.json");}
		if (p ==9 ){	
		updateData("Pza_mod_por/db/Dur.json");}
		if (p ==10 ){	
		updateData("Pza_mod_por/db/Gto.json");}
		if (p ==11 ){	
		updateData("Pza_mod_por/db/Gro.json");}
		if (p ==12 ){	
		updateData("Pza_mod_por/db/Hgo.json");}
		if (p ==13 ){	
		updateData("Pza_mod_por/db/Jal.json");}
		if (p ==14 ){	
		updateData("Pza_mod_por/db/Mex.json");}
		if (p ==15 ){	
		updateData("Pza_mod_por/db/Mic.json");}
		if (p ==16 ){	
		updateData("Pza_mod_por/db/Mor.json");}
		if (p ==17 ){	
		updateData("Pza_mod_por/db/Nay.json");}
		if (p ==18 ){	
		updateData("Pza_mod_por/db/Nle.json");}
		if (p ==19 ){	
		updateData("Pza_mod_por/db/Oax.json");}
		if (p ==20 ){	
		updateData("Pza_mod_por/db/Pue.json");}
		if (p ==21 ){	
		updateData("Pza_mod_por/db/Qro.json");}
		if (p ==22 ){	
		updateData("Pza_mod_por/db/Roo.json");}
		if (p ==23 ){	
		updateData("Pza_mod_por/db/Slp.json");}
		if (p ==24 ){	
		updateData("Pza_mod_por/db/Sin.json");}
		if (p ==25 ){	
		updateData("Pza_mod_por/db/Son.json");}
		if (p ==26 ){	
		updateData("Pza_mod_por/db/Tab.json");}
		if (p ==27 ){	
		updateData("Pza_mod_por/db/Tam.json");}
		if (p ==28 ){	
		updateData("Pza_mod_por/db/Tlx.json");}
		if (p ==29 ){	
		updateData("Pza_mod_por/db/Ver.json");}
		if (p ==30 ){	
		updateData("Pza_mod_por/db/Yuc.json");}
		if (p ==31 ){	
		updateData("Pza_mod_por/db/Zac.json");}
	}
...
if(nomEstado == "Pza_mod_por/db/Ags.json"){
...
if(nomEstado == "Pza_mod_por/db/Bcn.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Bcn"
...
if(nomEstado == "Pza_mod_por/db/Bcs.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Bcs"
...
if(nomEstado == "Pza_mod_por/db/Cam.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Cam"
...
if(nomEstado == "Pza_mod_por/db/Chp.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Chp"
...
if(nomEstado == "Pza_mod_por/db/Chi.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Chi"
...
if(nomEstado == "Pza_mod_por/db/Dif.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Dif"
...
if(nomEstado == "Pza_mod_por/db/Coa.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Coa"
...
if(nomEstado == "Pza_mod_por/db/Col.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Col"
...
if(nomEstado == "Pza_mod_por/db/Dur.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Dur"
...
if(nomEstado == "Pza_mod_por/db/Gto.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Gto"
...
if(nomEstado == "Pza_mod_por/db/Gro.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Gro"
...
if(nomEstado == "Pza_mod_por/db/Hgo.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Hgo"
...
if(nomEstado == "Pza_mod_por/db/Jal.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Jal"
...
if(nomEstado == "Pza_mod_por/db/Mex.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Mex"
...
if(nomEstado == "Pza_mod_por/db/Mic.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Mic"
...
if(nomEstado == "Pza_mod_por/db/Mor.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Mor"
...
if(nomEstado == "Pza_mod_por/db/Nay.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Nay"
...
if(nomEstado == "Pza_mod_por/db/Nle.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Nle"
...
if(nomEstado == "Pza_mod_por/db/Oax.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Oax"
...
if(nomEstado == "Pza_mod_por/db/Pue.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Pue"
...
if(nomEstado == "Pza_mod_por/db/Qro.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Qro"
...
if(nomEstado == "Pza_mod_por/db/Roo.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Roo"
...
if(nomEstado == "Pza_mod_por/db/Slp.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Slp"
...
if(nomEstado == "Pza_mod_por/db/Sin.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Sin"
...
if(nomEstado == "Pza_mod_por/db/Son.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Son"
...
if(nomEstado == "Pza_mod_por/db/Tab.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Tab"
...
if(nomEstado == "Pza_mod_por/db/Tam.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Tam"
...
if(nomEstado == "Pza_mod_por/db/Tlx.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Tlx"
...
if(nomEstado == "Pza_mod_por/db/Ver.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Ver"
...
if(nomEstado == "Pza_mod_por/db/Yuc.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Yuc"
...
if(nomEstado == "Pza_mod_por/db/Zac.json"){
for (var j = 0; j < (Object.keys(rawData)).length; j++) {
	    jsonArr.push({
			        "numero":j+1,
					"estado":"Zac"
